...
const { userSchema } = require('../common/validate-schema')
...
router.post('/register', validateBodyZod(userSchema.create), async function (req, res) {
...
router.post('/login', validateBodyZod(userSchema.create), passport.authenticate('local'), function (req, res) {
  res.success(true)
});
